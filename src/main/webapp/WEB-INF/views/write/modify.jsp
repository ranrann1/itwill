...
.buttons{
  ...
  <div class="row">
    ...
    <div class="col-lg-6">
    <p class="type">위치</p>
    <input class="form-control form-control-lg mb-3"  type="text" placeholder="" aria-label=".form-control-lg example" name="location" id="location" value="${board.location}">
	...
	<div class="col-lg-6">
	  ...
	  <p><input type="date" class="form-control form-control-lg mb-3"  aria-label=".form-control-lg example" id="sdate" name="sdate" value="${board.sdate}"></p>
	</div>
	<div class="col-lg-6">
	  <p class="type">모집 종료 예정일</p>
	  <p><input type="date" class="form-control form-control-lg mb-3"  aria-label=".form-control-lg example" id="edate" name="edate" value="${board.edate}"></p>
	</div>
    ...
    <div class="mb-3">
	  <p class="type">제목</p>
	  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="글 제목을 입력해주세요!" id="title" name="title" value="${board.title}">
	</div>
	<div class="mb-3">
	  <textarea class="form-control" id="exampleFormControlTextarea1" rows="8" placeholder="음식에 대해 소개해주세요!" id="content" name="content" >${board.content}</textarea>
	</div>
	<div class="buttons">
